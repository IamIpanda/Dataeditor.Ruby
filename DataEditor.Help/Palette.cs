...
namespace DataEditor.Help
{
    ...
    public class Painter
    {
        private Painter() 
        {
            ...
            now[4] = Color.FromArgb(255, 0, 0, 0);
            now[5] = Color.FromArgb(255, 0, 0, 0);
            now[6] = Color.FromArgb(255, 0, 0, 0);
            now[7] = Color.FromArgb(255, 0, 0, 0);
            now[8] = Color.FromArgb(255, 0, 0, 0);
            now[11] = Color.FromArgb(255, 0, 0, 0);
            now[12] = Color.FromArgb(255, 0, 0, 0);
            now[13] = Color.FromArgb(255, 0, 0, 0);
            now[16] = Color.FromArgb(255, 0, 0, 0);
            now[17] = Color.FromArgb(255, 0, 0, 0);
            now[18] = Color.FromArgb(255, 0, 0, 0);
            now[19] = Color.FromArgb(255, 0, 0, 0);
            now[20] = Color.FromArgb(255, 0, 0, 0);
            now[21] = Color.FromArgb(255, 0, 0, 0);
