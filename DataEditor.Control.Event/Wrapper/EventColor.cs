...
{
    public class EventColor : DataEditor.Control.WrapControlEditor<FuzzyData.FuzzyColor, Prototype.ProtoEventTone>
    {
        ...
        {
            base.Bind();
            Control.Mode = Prototype.ProtoEventTone.ToneMode.Color;
        }
    }
}
